        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control" id="title" name="title" placeholder="{{ __('voyager::generic.title') }}"
                ...
                <div class="panel">
                    ...
                    <div class="panel-body">
                        <input type="text" class="form-control" id="comment" name="comment" placeholder="Comment" value="@if(isset($dataTypeContent->comment)){{ $dataTypeContent->comment }}@endif">
                    </div>
                </div><!-- .panel -->
            ...
            <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="slug" {!!
                                isFieldSlugAutoGenerator($dataType, $dataTypeContent, "slug" ) !!} value="@if(isset($dataTypeContent->slug)){{ $dataTypeContent->slug }}@endif">
                        </div>
                ...
                <div class="panel panel-bordered panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        <img src="{{ filter_var($dataTypeContent->images, FILTER_VALIDATE_URL) ? $dataTypeContent->images : Voyager::image( $dataTypeContent->image ) }}"
                            style="width:100%" />
                        @endif
