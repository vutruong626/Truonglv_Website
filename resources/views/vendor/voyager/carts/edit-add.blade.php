...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.carts.update', $dataTypeContent->id) }}@else{{ route('voyager.carts.store') }}@endif"
            ...
            <div class="col-md-12">
                <div class="panel">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-number"> Number of Orders:</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <input type="text" class="form-control" id="number" name="number" placeholder="Number of Orders" value="@if(isset($dataTypeContent->email)){{ $dataTypeContent->title }}@endif">
                        </div>
                        <div class="panel-heading">
                            <h3 class="panel-address"> Price:</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        ...
                        <div class="panel-body">
                            <input type="text" class="form-control" id="price" name="price" placeholder="Price"
                                value="@if(isset($dataTypeContent->price)){{ $dataTypeContent->phone }}@endif">
                        </div>
                    </div>
