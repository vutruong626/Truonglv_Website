...
<div class="page-content container-fluid">
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.backgrounds.update', $dataTypeContent->id) }}@else{{ route('voyager.backgrounds.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="panel">
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-content"> Content</h3>
                            <div class="panel-actions">
