				...
				<table width="700" border="0" align="center" cellpadding="0" style="background-color:#fff" cellspacing="0">
					...
					<tbody><tr>
						<td align="center" valign="top" bgcolor="#0070ce" style="border-left:1px solid #2e4d8d;border-right:1px solid #2e4d8d;border-top:1px solid #2e4d8d;padding:3px;color:#fff    background: #60f508">
							<a style="color:#fff" href="http://greenliving.vip/" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://greenliving.vip&amp;source=gmail&amp;ust=1537777122118000&amp;usg=AFQjCNHs_vWG2wyOSVnO8DGbKy-LcQMn2Q">greenliving.vip</a></td>
						</tr>
						<tr>
													...
													<tbody>
														<tr>
															<td align="left" valign="top">
																...
																<div style="border:1px solid #c9d7f1;padding:5px;font-size:12px;width:auto;margin:0px">
																	Xin chào,&nbsp;<strong style="color:#5fef0a">Anh / Chị </strong><br>
																	Thông tin đơn hàng của bạn tại <a href="http://greenliving.vip/" style="color:#0070ce;text-decoration:none" target="_blank" data-saferedirecturl="https://www.google.com/url?q=http://greenliving.vip/&amp;source=gmail&amp;ust=1537777122118000&amp;usg=AFQjCNFR0uCvW0T9sxh5zUBPcp4MLyDZHw">greenliving.vip</a>						  </div>
																	<br>	
															</td>
														</tr>
														<tr>
														...
														<tr>
															<td align="left" valign="top">
																		...
																		<tr>
																			<td>
																				<a href="" target="_blank" data-saferedirecturl="">
																					<img id="" src="{{asset('storage/'.$v->images)}}" alt="{{$v->name}}" border="0" width="50" height="60" >
																				</a>
																			</td>
																			<td>
																...
																<br>
																<p>CẢM  ƠN  QUÝ KHÁCH MUA HÀNG  TẠI MHD PHARMA</p>
															</td>
														</tr>
													</tbody>
												</table>
